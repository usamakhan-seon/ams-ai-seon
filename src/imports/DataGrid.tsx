import svgPaths from "./svg-adgevdwaok";
...
function Lozenge() {
  return (
    <div className="bg-[#e6f9f8] content-stretch flex h-[18px] items-center px-[4px] py-px relative rounded-[3px] shrink-0" data-name="Lozenge">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] not-italic relative shrink-0 text-[#009a92] text-[11px] text-nowrap tracking-[0.4px] uppercase whitespace-pre">Closed</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Avatar">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_69_14013)" id="Avatar">
          <g id="Avatar_2">
...
function Lozenge1() {
  return (
    <div className="bg-[#fefae9] content-stretch flex h-[18px] items-center px-[4px] py-px relative rounded-[3px] shrink-0" data-name="Lozenge">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] not-italic relative shrink-0 text-[#60500e] text-[11px] text-nowrap tracking-[0.4px] uppercase whitespace-pre">In progress</p>
    </div>
  );
}
...
function Lozenge3() {
  return (
    <div className="bg-[#e6f9f8] content-stretch flex h-[18px] items-center px-[4px] py-px relative rounded-[3px] shrink-0" data-name="Lozenge">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] not-italic relative shrink-0 text-[#009a92] text-[11px] text-nowrap tracking-[0.4px] uppercase whitespace-pre">Escalated to case</p>
    </div>
  );
}
...
function Avatar7() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Avatar">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_69_14021)" id="Avatar">
          <g id="Avatar_2">
...
export default function DataGrid() {
  return (
    <div className="content-stretch flex flex-col isolate items-start relative size-full" data-name="Data Grid">
      <AlertListTableRow />
      <AlertListTableRow1 />
      <AlertListTableRow2 />
      <AlertListTableRow3 />
