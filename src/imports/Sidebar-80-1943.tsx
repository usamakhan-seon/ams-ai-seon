import svgPaths from "./svg-m05st3o4hq";
  ...
  return (
    <div className="bg-[rgba(255,255,255,0.1)] relative rounded-[6px] shrink-0 w-full" data-name="_base / Sidebar Item">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[12px] py-[8px] relative w-full">
          <Icon2 />
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#00c1b6] text-[14px] text-nowrap whitespace-pre">Customers</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative rounded-[6px] shrink-0 w-full" data-name="_base / Sidebar Item">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[12px] py-[8px] relative w-full">
          <Icon3 />
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">Alerts</p>
        </div>
      </div>
    </div>
  );
...
function Icon9() {
  return (
    <div className="absolute right-[-8px] size-[12px] top-1/2 translate-y-[-50%]" data-name="Icon">
      <p className="absolute font-['Font_Awesome_6_Pro:Regular',sans-serif] leading-[12px] left-1/2 not-italic text-[11px] text-[rgba(255,255,255,0.64)] text-center top-[calc(50%-6px)] translate-x-[-50%] w-[12px]"></p>
    </div>
  );
}
