import svgPaths from "./svg-n9jteaedw7";
...
function AppHeader() {
  return (
    <div className="bg-white relative shadow-[0px_1px_0px_0px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="App Header">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pl-[16px] pr-[8px] py-[4px] relative w-full">
          <Leftside />
          <Buttons />
        </div>
      </div>
...
function PageHeader() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] isolate items-start relative shrink-0 w-full" data-name="Page Header">
      <PageTitle />
      <TabNavigation />
    </div>
  );
...
function Card() {
  return (
    <div className="basis-0 bg-white grow min-h-px min-w-px relative rounded-[8px] shrink-0 w-full" data-name="Card">
  ...
  return (
    <div className="content-stretch flex gap-[4px] items-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="No. of items">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#282a2e] text-[0px] text-[14px] text-nowrap whitespace-pre">
        1-100<span className="font-['Inter:Regular',sans-serif] font-normal text-[#525761]">{` of 168`}</span>
      </p>
      <Icon16 />
    </div>
  );
...
function Icon17() {
  return (
    <div className="relative shrink-0 size-[16px] z-[2]" data-name="Icon">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-[16px]">
        <p className="absolute font-['Font_Awesome_6_Pro:Regular',sans-serif] leading-[16px] left-1/2 not-italic text-[#80899c] text-[16px] text-center top-[calc(50%-8px)] translate-x-[-50%] w-[16px]">angle-left</p>
      </div>
    </div>
  );
}
...
function Icon18() {
  return (
    <div className="relative shrink-0 size-[16px] z-[1]" data-name="Icon">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-[16px]">
        <p className="absolute font-['Font_Awesome_6_Pro:Regular',sans-serif] leading-[16px] left-1/2 not-italic text-[#80899c] text-[16px] text-center top-[calc(50%-8px)] translate-x-[-50%] w-[16px]">angle-right</p>
      </div>
    </div>
  );
}
...
function Pagination() {
  return (
    <div className="absolute bg-white bottom-0 content-stretch flex items-center justify-between left-[-345px] pl-[16px] pr-[24px] py-[8px] right-[-345px] shadow-[0px_-1px_0px_0px_rgba(0,0,0,0.1)]" data-name="Pagination">
      <NoOfItems />
      <CurrentPage />
    </div>
  );
...
function ContentWrapper() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-full" data-name="Content Wrapper">
      <div className="size-full">
